...
public class CatalogContextSeed
{
    ...
    static IEnumerable<CatalogItem> GetPreconfiguredItems()
    {
        return new List<CatalogItem>
        {
            ...
            new(1, 6, ".NET LOGIC Mug", ".NET LOGIC Mug", 8.50M, "http://catalogbaseurltobereplaced/images/products/2.png"),
            ...
            new(2, 2, "ROSLYN RED SHEET", "ROSLYN RED SHEET", 8.5M, "http://catalogbaseurltobereplaced/images/products/13.png") { Localidad = "Quito" },
            new(2, 2, ".NET BOT BLACK SWEATSHIRT", ".NET BOT BLACK SWEATSHIRT", 19.5M, "http://catalogbaseurltobereplaced/images/products/14.png") { Localidad = "Quito" },
            new(2, 2, ".NET BLUE SWEATSHIRT", ".NET BLUE SWEATSHIRT", 12M, "http://catalogbaseurltobereplaced/images/products/15.png") { Localidad = "Quito" },
            new(1, 5, "CUP<T> WHITE MUG", "CUP<T> WHITE MUG", 12M, "http://catalogbaseurltobereplaced/images/products/16.png") { Localidad = "Guayaquil" },
            new(2, 5, "ROSLYN RED T-SHIRT", "ROSLYN RED T-SHIRT", 12M, "http://catalogbaseurltobereplaced/images/products/17.png") { Localidad = "Guayaquil" },
        };
    }
}
